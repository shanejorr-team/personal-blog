---
name: captions
description: Draft captions for photos staged in src/images/photography/_staging/photo-template.csv. Use when the user asks to write or draft captions for staged photos.
---
