...
<figure class="my-8">
  ...
  <figcaption class="text-center text-sm text-gray-600 mt-2">LLMs rely on internet writings for their pre-training data. They tirelessly read this data during pre-training.</figcaption>
</figure>
...
<figure class="my-8">
  ...
  <figcaption class="text-center text-sm text-gray-600 mt-2">LLMs update their weights after each word they ingest. Therefore, your writings impact them, even if only by a minuscule amount.</figcaption>
</figure>
