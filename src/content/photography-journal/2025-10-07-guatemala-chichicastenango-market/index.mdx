...
<InlineFigure src={photo6} alt="Tuk-Tuks are the preferred mode of transportation from Chichi to the surrounding towns" caption="Tuk-tuk taxis are the preferred mode of transportation from Chichi to the surrounding towns" />
