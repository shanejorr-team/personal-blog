...
<figure class="my-8">
  <Picture src={photo2} alt="Views along Ruta Nacional 7 in Argentina" formats={['avif', 'webp']} class="rounded-lg" />
  <figcaption class="text-center text-sm text-gray-600 mt-2">The drive from Mendoza to Cerro Penitentes along Ruta Nacional 7 is filled with views such as this.</figcaption>
</figure>
...
<figure class="my-8">
  <Picture src={photo1} alt="Stream along Ruta Nacional 7 in Argentina" formats={['avif', 'webp']} class="rounded-lg" />
  <figcaption class="text-center text-sm text-gray-600 mt-2">There is no shortage of spots to pull over and take photos on Rutan Nacional 7.</figcaption>
</figure>
...
<figure class="my-8">
  <Picture src={photo3} alt="Views of Rutan Nacional 7 ner the Cerro Penitentes trailhead" formats={['avif', 'webp']} class="rounded-lg" />
  <figcaption class="text-center text-sm text-gray-600 mt-2">The hike makes a climb soon after the trailhead, offering views of Ruta Nacional 7 in the background.</figcaption>
</figure>
...
<figure class="my-8">
  <Picture src={photo4} alt="Views along the trail to Cerro Penitentes in Argentina" formats={['avif', 'webp']} class="rounded-lg" />
  <figcaption class="text-center text-sm text-gray-600 mt-2">Hiking the valley on day one. Easy hike with snow-covered mountains surrounding the valley.</figcaption>
</figure>
...
<figure class="my-8">
  <Picture src={photo5} alt="Tent at camping spot at Refugio Grajales on Cerro Penitentes hike." formats={['avif', 'webp']} class="rounded-lg" />
  <figcaption class="text-center text-sm text-gray-600 mt-2">Camping spot at Refugio Grajales.</figcaption>
</figure>
...
<figure class="my-8">
  <Picture src={photo6} alt="Scenic views from the hike to the top of Cerro Penitentes in Argentina." formats={['avif', 'webp']} class="rounded-lg" />
  <figcaption class="text-center text-sm text-gray-600 mt-2">Day two immediately starts with a climb. My tent is visible in the bottom left corner as the bright red dot.</figcaption>
</figure>
...
<figure class="my-8">
  <Picture src={photo7} alt="High-elevation snow on the trail in teh hike to Cerro Penitentes." formats={['avif', 'webp']} class="rounded-lg" />
  <figcaption class="text-center text-sm text-gray-600 mt-2">Trail snow provided welcome relief from scree since it is more stable than scree.</figcaption>
</figure>
...
<figure class="my-8">
  <Picture src={photo8} alt="The Andes from the summit of Cerro Penitentes." formats={['avif', 'webp']} class="rounded-lg" />
  <figcaption class="text-center text-sm text-gray-600 mt-2">The summit of Cerro Penitentes offers wonderful views in all directions.</figcaption>
</figure>
...
<figure class="my-8">
  <Picture src={photo9} alt="The Andes from the summit of Cerro Penitentes." formats={['avif', 'webp']} class="rounded-lg" />
  <figcaption class="text-center text-sm text-gray-600 mt-2">The Andian peaks visible from Cerro Penitentes all have similar looks.</figcaption>
</figure>
...
<figure class="my-8">
  <Picture src={photo11} alt="Aconcagua from the summit of Cerro Penitentes." formats={['avif', 'webp']} class="rounded-lg" />
  <figcaption class="text-center text-sm text-gray-600 mt-2">Aconcagua is the peak on teh right, slightly higher than its surroundings.</figcaption>
</figure>
...
<figure class="my-8">
  <Picture src={photo10} alt="The Andes from the summit of Cerro Penitentes." formats={['avif', 'webp']} class="rounded-lg" />
  <figcaption class="text-center text-sm text-gray-600 mt-2">Aconcagua is the star on Cerro Penitentes, but there are great views besides Aconcagua.</figcaption>
</figure>
